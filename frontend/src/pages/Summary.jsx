  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle={`${doc?.page_count || 0} pages • Processing with Hybrid AI`}
        action={
      ...
      <div className="grid lg:grid-cols-3 gap-16">
          ...
          <div className="glass-card p-8 relative">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white tracking-tight">AI Synthesis</h3>
        ...
        <div className="space-y-12">
          ...
          <div className="glass-card p-10 border-l-4 border-l-indigo-500/50">
            <h4 className="text-xs font-black text-slate-500 uppercase tracking-[0.2em] mb-4">Pipeline Status</h4>
            <p className="text-sm text-slate-400 leading-relaxed mb-8">
              Utilizing **Groq Llama 3.1** (High-Speed Inference) with **Hugging Face BART** redundancy for massive context stability.
            </p>
            <div className="flex items-center gap-3">
              <div className="w-2.5 h-2.5 rounded-full bg-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.5)]" />
              <span className="text-xs text-emerald-500 font-black uppercase tracking-widest">Optimal Sync</span>
            </div>
          </div>
