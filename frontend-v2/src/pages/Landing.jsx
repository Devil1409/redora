...
const features = [
  { icon: HiOutlineDocumentText, title: 'Smart PDF Processing', desc: 'Upload any PDF and Redora extracts, cleans, and structures the content for optimal learning.' },
  { icon: HiOutlineLightningBolt, title: 'Smart Summarization', desc: 'Get instant, comprehensive summaries powered by our ultra-fast Redora engine.' },
  { icon: HiOutlineAcademicCap, title: 'Adaptive Quizzes', desc: 'Smartly generated quizzes that adapt difficulty based on your performance and weak areas.' },
      ...
      <section className="relative z-10 w-full max-w-7xl px-8 md:px-16 pt-32 pb-48 flex flex-col items-center text-center">
        ...
        <div className="space-y-12 max-w-4xl pt-10">
          <p className="text-xl md:text-2xl text-slate-400 max-w-5xl mx-auto leading-relaxed font-medium">
            Redora Smart Learning Assistant with Summarization and Quiz Generation.<br />
            Learn faster with Redora intelligence.
          </p>
